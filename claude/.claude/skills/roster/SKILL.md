...
- Per-agent: `--budget inherit --set team-reviewer=<model>:<effort>` (repeatable; other agents stay as they are). Back to inheritance for everyone: `--budget inherit` with no `--set`
