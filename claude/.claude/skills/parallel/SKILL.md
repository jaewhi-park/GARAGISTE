...
2. Start no new work while waiting. As each completion report arrives, have team-planner record branch · worktree path · result under an "Awaiting integration" list in docs/STATUS.md.
