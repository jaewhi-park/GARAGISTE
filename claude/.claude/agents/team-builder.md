...
- Before the first edit, read docs/memory/team-reviewer.md (this repository's recurring defect patterns) and walk them against each step's diff before its commit; the report's Self-check line names what applied.
