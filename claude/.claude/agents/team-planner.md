...
- Specs: docs/specs/NNNN-<slug>.md per .claude/skills/spec/SKILL.md (Read it before writing). Spec = what and when done, in the CEO's words; ADR = why this design; plan = how. Never fill undecided items with guesses.
