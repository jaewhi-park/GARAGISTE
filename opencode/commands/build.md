...
0. Read the plan file (it is short). If the current branch is main/master, run `git switch -c plan/<slug>` yourself (slug from the plan filename). One plan = one branch.
...
3. On PASS, update the Step and Last-verifier lines of docs/STATUS.md yourself and move to the next step.
