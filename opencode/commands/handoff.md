...
2. Update docs/STATUS.md in the status-board format: plan and branch, step progress and last verifier result, open review findings, decisions waiting on the CEO, next three actions.
