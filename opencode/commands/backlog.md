...
1. Have team-planner update docs/BACKLOG.md. Item format: title / one-sentence user value / completion criteria (verifiable) / size (S·M·L) / priority (P0–P2) / dependencies / spec (docs/specs/NNNN-<slug>.md or —). Also sweep approved specs' "Not this time" and uncovered "Done when" items for candidates.
