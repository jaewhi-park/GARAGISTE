...
7. Update docs/STATUS.md and have team-planner append one line to docs/METRICS.md: date / slug / logic diff lines / verifier failures / review blockers / CEO questions / plan-approval→ship duration. (/retro reads this file)
