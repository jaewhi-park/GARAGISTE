---
description: Investigates requirements and the codebase and writes plans (docs/plans), the product spec (docs/SPEC.md), design docs, ADRs, the backlog and AGENTS.md. Never edits code.
mode: subagent
temperature: 0.3
steps: 60
color: info
