...
- Money: a paid external service, a new runtime dependency (license, size, security). Dev dependencies and patch bumps: decision log only, no question
