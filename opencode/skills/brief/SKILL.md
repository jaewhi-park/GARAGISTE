...
- Lifecycle: /brainstorm creates it (approved) and revises it (revised); /kickoff and /assess derive docs/CHARTER.md from it and settle its Undecided items at their confirmation question; /backlog sweeps Later and the appendix; /kickoff writes docs/SPEC.md from the Decided lines and the appendix; /hire reads it for the project's character.
